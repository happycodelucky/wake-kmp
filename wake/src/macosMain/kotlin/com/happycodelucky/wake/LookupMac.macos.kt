 ...
 * with, so [MacLookupException.NotInCache] is a normal failure for an idle host —
 ...
 * [MacLookupException.LookupFailed].
 *
 * Never throws (other than coroutine cancellation). A resolved MAC is in the
